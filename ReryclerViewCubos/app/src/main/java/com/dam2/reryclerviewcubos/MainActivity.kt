...
import com.dam2.reryclerviewcubos.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       // setContentView(R.layout.activity_main)
        ...
        Almacen.cubos = FactoriaListaCubos.generaLista(12)
        Log.e("ACSCO", Almacen.cubos.toString())

        miRecyclerView = binding.listaCubosRecycler as RecyclerView
        ...
        var miAdapter = MiAdaptadorRecycler(Almacen.cubos, this)
        ...
        binding.btnDetalle.setOnClickListener {
            if (MiAdaptadorRecycler.seleccionado >= 0) {
                val pe = Almacen.cubos.get(MiAdaptadorRecycler.seleccionado)
                Log.e("ACSCO",pe.toString())
                var inte : Intent = Intent(contextoPrincipal, MainActivity2::class.java)
                inte.putExtra("obj",Almacen.cubos.get(MiAdaptadorRecycler.seleccionado))
