...
import com.dam2.reryclerviewcubos.MainActivity
import com.dam2.reryclerviewcubos.MainActivity2
import com.dam2.reryclerviewcubos.R
...
//        return ViewHolder(layoutInflater.inflate(R.layout.item_card,parent,false))
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val nombrePersonaje = view.findViewById(R.id.txtNombre) as TextView
        val tipoPersonaje = view.findViewById(R.id.txtMarca) as TextView
        val avatar = view.findViewById(R.id.imgImagen) as ImageView
        ...
        fun bind(pers: Cubo, context: Context, pos: Int, miAdaptadorRecycler: MiAdaptadorRecycler) {
            nombrePersonaje.text = pers.nombre
            tipoPersonaje.text = pers.marca
...
//            }
            ...
            itemView.setOnClickListener {
                if (pos == seleccionado) {
                    ...
                    Log.e(
                        "ACSC0",
                        "Seleccionado: ${Almacen.cubos.get(seleccionado).toString()}"
                    )
                }
